...
Footer.defaultProps = {
    siteDescription:
        "Our mission is to help bring the highest quality CBD products to the market. We understand that many people use these products to help with serious health issues and we dont take that responsibility lightly.",
    ...
    contactInfoText: "Contact us for more information.",
    /*address: "2750 Quadra Street , Park Area, Victoria, Canada.",
    phone: "+(00) 01245687",*/
    email: "sales.cbd@mybuycbd.com",
